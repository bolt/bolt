...
class BackendAdminCest
{
     ...
     * @return array
     */
    private function _readYaml($file)
    {
     ...
     * @return string
     */
    private function _getUpdatedPermissions()
    {
        $permissions = $this->_readYaml('permissions.yml');
     ...
     * @param \AcceptanceTester $I
     */
    public function updatePermissionsTest(\AcceptanceTester $I)
    {
        $I->wantTo('update permissions.yml');
        $I->loginAs($this->user['admin']);

        $I->amOnPage('bolt/file/edit/config/permissions.yml');
        $perms = $this->_getUpdatedPermissions();
