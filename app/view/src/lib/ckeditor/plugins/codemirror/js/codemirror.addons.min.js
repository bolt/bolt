...
a[e](b,f),d)return d}});b.registerHelper("fold","auto",function(a,b){for(var f=a.getHelpers(b,"fold"),d,e=0;e<f.length;e++)if(d=f[e](a,b),d)return d});var d={rangeFinder:b.fold.auto,widget:"↔",minFoldSize:0,scanUp:!1};b.defineOption("foldOptions",null)});
