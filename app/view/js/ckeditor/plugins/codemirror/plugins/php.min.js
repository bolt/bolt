...
a(require("../../lib/codemirror"),require("../htmlmixed/htmlmixed"),require("../clike/clike")):"function"==typeof define&&define.amd?// AMD
define(["../../lib/codemirror","../htmlmixed/htmlmixed","../clike/clike"],a):// Plain browser env
a(CodeMirror)}(function(a){"use strict";function b(a){for(var b={},c=a.split(" "),d=0;d<c.length;++d)b[c[d]]=!0;return b}function c(a){return function(b,c){return b.match(a)?c.tokenize=null:b.skipToEnd(),"string"}}
// Helper for stringWithEscapes
function d(a){return 0==a.length?e:function(b,c){for(var f=a[0],g=0;g<f.length;g++)if(b.match(f[g][0]))return c.tokenize=d(a.slice(1)),f[g][1];return c.tokenize=e,"string"}}function e(a,b){var c,e=!1,f=!1;if('"'==a.current())return"string";
// "Complex" syntax
...
return a.match("[",!1)&&(b.tokenize=d([[["[",null]],[[/\d[\w\.]*/,"number"],[/\$[a-zA-Z_][a-zA-Z0-9_]*/,"variable-2"],[/[\w\$]+/,"variable"]],[["]",null]]])),a.match(/\-\>\w/,!1)&&(b.tokenize=d([[["->",null]],[[/[\w]+/,"variable"]]])),"variable-2";
// Normal string
