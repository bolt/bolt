...
b.slice(0,d));var g=c.mode.token(a,e.inner);return-1<d&&(a.string=b),d==a.pos&&c.parseDelimiters&&(e.innerActive=e.inner=null),c.innerStyle&&(g=g?g+" "+c.innerStyle:c.innerStyle),g}for(var g=1/0,b=a.string,m=0;m<l.length;++m){c=l[m];d=k(b,c.open,a.pos);if(d==a.pos)return c.parseDelimiters||a.match(c.open),e.innerActive=c,b=0,h.indent&&(d=h.indent(e.outer,"",""),d!==f.Pass&&(b=d)),e.inner=f.startState(c.mode,b),c.delimStyle&&c.delimStyle+" "+c.delimStyle+"-open";-1!=d&&d<g&&(g=d)}g!=1/0&&(a.string=
b.slice(0,g));d=h.token(a,e.outer);return g!=1/0&&(a.string=b),d},indent:function(a,e,c){var b=a.innerActive?a.innerActive.mode:h;return b.indent?b.indent(a.innerActive?a.inner:a.outer,e,c):f.Pass},blankLine:function(a){var e=a.innerActive?a.innerActive.mode:h;if(e.blankLine&&e.blankLine(a.innerActive?a.inner:a.outer),a.innerActive)"\n"===a.innerActive.close&&(a.innerActive=a.inner=null);else for(var c=0;c<l.length;++c){var b=l[c];"\n"===b.open&&(a.innerActive=b,a.inner=f.startState(b.mode,e.indent?
e.indent(a.outer,"",""):0))}},electricChars:h.electricChars,innerMode:function(a){return a.inner?{state:a.inner,mode:a.innerActive.mode}:{state:a.outer,mode:h}}}}});
...
l=/^[+\-*&%=<>!?|~^]/,a=/^[:\[\(\{]/,e="true;false;null;empty;defined;divisibleby;divisible by;even;odd;iterable;sameas;same as".split(";"),c=/^(\d[+\-\*\/])?\d+(\.\d+)?/;return k=new RegExp("(("+k.join(")|(")+"))\\b"),e=new RegExp("(("+e.join(")|(")+"))\\b"),{startState:function(){return{}},token:function(b,a){return f(b,a)}}});f.defineMode("twig",function(h,k){var l=f.getMode(h,"twig:inner");return k&&k.base?f.multiplexingMode(f.getMode(h,k.base),{open:/\{[{#%]/,close:/[}#%]\}/,mode:l,parseDelimiters:!0}):
