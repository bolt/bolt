 ...
 * @see https://core.trac.wordpress.org/browser/tags/3.8.1/src/wp-includes/formatting.php#L572
 *
...
/**
 * Ported from https://github.com/l3pp4rd/DoctrineExtensions/blob/master/lib/Gedmo/Sluggable/Util/Urlizer.php
 * @param $string
 * @return bool
 */
function seemsUtf8($string)
{
...
function makeSlug($str, $length = 64) {
    ...
    $special = array_merge($symbols,$graphics,$classic,$arrows,$currency);
    ...
    $str = str_replace( array( '%c2%a0', '%e2%80%93', '%e2%80%94' ), $separator, $str );
    ...
    $str = preg_replace('/[^%a-z\/0-9 _-]/', '', $str);//@todo
