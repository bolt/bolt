...
class Users
{
     ...
     */
    public function isAllowed($what, $content = null, $contenttype = null, $contentid = null)
    {
        $user = $this->currentuser;

        return $this->app['permissions']->isAllowed($what, $user, $content, $contenttype, $contentid);
    }
